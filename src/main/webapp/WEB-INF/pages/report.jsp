...
<body id="body-pd">
    ...
    <div class="container body-container text-center justify-content-md-center">
        ...
        <p class="lead mb-5">You can generate the weekly report or monthly of a particular doctor.</p>

        <form action="exportdoctors" method="post" autocomplete="off">
            <div class="row d-flex justify-content-center form-row text-start mt-5">
            	<div class="col col-1 m-4"></div>
                ...
                <div class="form-group col-2 m-2">
                    <label for="type" class="form-label">Choose Report Type</label>
